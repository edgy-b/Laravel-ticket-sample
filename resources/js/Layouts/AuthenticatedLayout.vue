        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div v-if="$page.props.auth.user.is_admin" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('types')" :active="route().current('types')">
                                    Ticket types
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    ...
                    <div v-if="$page.props.auth.user.is_admin" class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('types')" :active="route().current('types')">
                            Ticket types
                        </ResponsiveNavLink>
                    </div>
